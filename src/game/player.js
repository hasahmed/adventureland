game.module(
    ...
    .body(function () {
        ...
        game.createClass('Player', 'PhysicsSprite', {
            ...
            walkSpeed: 100,
            dSpeed: function () {
                return 1 / Math.sqrt(2) * this.walkSpeed;
            },
            init: function () {
                ...
                this.animation.addAnim("walkUp", [18, 19, 20, 19], {
                    speed: animSpeed
                });
                this.animation.addAnim("walkRight", [12, 13, 14, 13], {
                    speed: animSpeed
                });
                this.animation.addAnim("walkDown", [0, 1, 2, 1], {
                    speed: animSpeed
                });
                this.animation.addAnim("walkLeft", [6, 7, 8, 7], {
                    speed: animSpeed
                });
                this.animation.addAnim("walkLeftDown", [24, 25, 26, 25], {
                    speed: dAnimSpeed
                });
                this.animation.addTo(this);
                this.animation.addAnim("walkRightDown", [30, 31, 32, 31], {
                    speed: dAnimSpeed
                });
                this.animation.addAnim("walkLeftUp", [36, 37, 38, 37], {
                    speed: dAnimSpeed
                });
                this.animation.addAnim("walkRightUp", [42, 43, 44, 43], {
                    speed: dAnimSpeed
                });
