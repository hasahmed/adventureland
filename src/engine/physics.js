...
game.createClass('PhysicsSprite', 'Sprite', {
    ...
    **/
    ...
    init: function(texture, width, height) {
        ...
        this.body.owner = this; //cmaidi
    },

    addTo: function(container) {
        if (!game.scene.world) game.scene.world = new game.World(0, 0); //cmaidi
    ...
    **/
    ...
    remove: function() {
        if (!this.body._remove) this.body.remove(); //cmaidi
        return this.super();
    }
});
